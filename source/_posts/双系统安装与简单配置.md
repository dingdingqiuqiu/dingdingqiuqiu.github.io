...
`Clash for Windows`可以用[Clash Verge](https://github.com/zzzgydi/clash-verge/releases/tag/v1.3.8)代替![2023-11-07_12-26](双系统安装与简单配置.assets/2023-11-07_12-26.png)

系统代理设置这里和`Clash for windows`一致

![2023-11-07_12-34](双系统安装与简单配置.assets/2023-11-07_12-34.png)
